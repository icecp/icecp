...
public class MetadataUtilsTest {
    ...
    public void testToName() {
        Metadata m = new Persistence(123);
        String result = MetadataUtils.toName(m);
        assertEquals("persistence", result);
    }

    @Test
    public void testToNameFromClass() {
        String result = MetadataUtils.toName(Window.class);
        assertEquals("window", result);
    }

    @Test
    public void testGetDefaultFormat() {
        assertNotNull(MetadataUtils.getDefaultFormat(Frequency.class));
    }
}
