...
/**
 * Operation that encodes/decodes a {@link Message} using a given {@link Format}
 *
 */
public class FormattingOperation extends Operation<Message, InputStream> {
     ...
     */
    public FormattingOperation(Format format) {
    ...
    public InputStream execute(Message input) throws OperationException {
        ...
        } catch (FormatEncodingException | ClassCastException ex) {
    ...
    public Message executeInverse(InputStream input) throws OperationException {
        ...
        } catch (IOException | FormatEncodingException | ClassCastException ex) {
